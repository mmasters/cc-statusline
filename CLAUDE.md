...
A custom Claude Code statusline — a single bash script (`statusline.sh`) that transforms Claude Code's JSON session data into a 5-line colored terminal display showing directory/git info, environment, context usage, cost/tokens, and rotating tips.
...
**Output:** 5 lines of ANSI-colored text
...
| 316–403   | Rendering: assembles and prints the 5 output lines         |
